            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?=base_url('eliminar_usuario/').$usuario['usuario_id'];?>" class="btn btn-success"><i class="bi bi-trash3"></i></a>
                            <a href="<?=base_url('buscar_usuario/').$usuario['usuario_id'];?>"class="btn btn-success"><i class="bi bi-pencil-square"></i></a>
                        </td>
                    </tr>
                    <?php
                     } 
