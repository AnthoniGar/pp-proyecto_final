...
$routes->get('metodos_pagos','MetodosPagosController::index');
...
$routes->post('agregar_metodos_pagos','MetodosPagosController::agregarMetodosPagos');
...
$routes->get('buscar_metodos_pagos/(:num)','MetodosPagosController::buscarMetodosPagos/$1');
